...
function calculateAge(){
    ...
    let curretMonth = today.getMonth()+1;
    ...
    if(
        ...
        (inputMonth > curretMonth && inputYear == currentYear) ||
        (inputDate > currentDate && inputMonth == curretMonth && inputYear == currentYear))

    {
        ...
        if(curretMonth >= inputMonth){
            resultMonth = curretMonth - inputMonth;
        }

        else{
            resultYear--;
            resultMonth = 12 + curretMonth - inputMonth;
        }
